...
interface CompanyItemProp {
  item?: ContactStructure | null | undefined;
  requestUpdate?: any;
}
...
export default function ChangeContact({
  ...
  var [info, setInformation] = useState<ContactStructure | null | undefined>();
  ...
  const UpdateContactInfo = async () => {
    var Result = await apiClient.patch<ApiResponseStructure<ContactStructure>>(
      `/company/${item!.CompanyId}/contact/${item!.id}`,info
    );
  ...
  return (
    <View style={styles.modalContainer}>
      <Card style={styles.Card}>
        <Text>Alterando Dados de Contato</Text>
